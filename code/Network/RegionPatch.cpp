...
void ChangeRegion(){
    ...
    if(Pulsar::Settings::GetSettingValue(Pulsar::SETTINGSTYPE_RACE, VP::SETTINGRACE_SCROLLER_MODE) == VP::RACESETTING_MODE_BSS){
    ...
    else if(Pulsar::Settings::GetSettingValue(Pulsar::SETTINGSTYPE_RACE, VP::SETTINGRACE_SCROLLER_MODE) == VP::RACESETTING_MODE_BBB){
    ...
    else if(Pulsar::Settings::GetSettingValue(Pulsar::SETTINGSTYPE_RACE, VP::SETTINGRACE_SCROLLER_MODE) == VP::RACESETTING_MODE_CHAOTIC){
...
Pulsar::SettingsHook PatchSearchRegion(ChangeRegion);